...
import { defaultThm, greyThm } from "ui/themes";
...
const Topbar = props => {
  const { controls, conditions, lingo, location, siblingPath } = props;
  ...
  return (
    <ThemeProvider theme={conditions.hasModal ? greyThm : defaultThm}>
      <Fragment>
