...
import { Action, Body, Cover, Head, TextString } from "ui/components";
  ...
  query WorksBySlug($uid: String!) {
    prismicWorks(uid: { eq: $uid }) {
      ...
      data {
        ...
        dateEn: date(formatString: "MMMM YYYY", locale: "en")
        datePl: date(formatString: "MMMM YYYY", locale: "pl")
        city
        map
        authors {
          author {
