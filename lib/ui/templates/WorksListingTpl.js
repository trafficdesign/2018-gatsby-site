...
const TabLink = styled.a`
  ...
  color: ${({ isActive, theme }) =>
    isActive ? theme.actionColor : theme.tabColor};
            ...
            <ThemeProvider theme={blueThm}>
              <Toolbar>
                <Tabs>
                  <Tab>
                    <TabLink
                      isActive={filter === "mural" || filter === "all"}
                  ...
                  <Tab>
                    <TabLink
                      isActive={filter === "szyld" || filter === "all"}
                  ...
                  <Tab>
                    <TabLink
                      isActive={filter === "blok" || filter === "all"}
                  ...
                  <Tab>
                    <TabLink
                      isActive={filter === "rzezba" || filter === "all"}
                  ...
                  <Tab>
                    <TabLink
                      isActive={filter === "detal" || filter === "all"}
